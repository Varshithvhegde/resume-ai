  ...
  const features = [
    {
      ...
      description:
        "Connect your Google Doc resume and let AI analyze and optimize it automatically",
    },
    {
      icon: <Database className="w-5 h-5" />,
      title: "Persistent Profile",
      description:
        "Save your resume data once - experience, education, skills, and projects stored securely",
    },
    {
      icon: <Target className="w-5 h-5" />,
      title: "Job-Tailored Resumes",
      description:
        "Paste any job description and get a customized resume optimized for that role",
    },
    {
      icon: <Mail className="w-5 h-5" />,
      title: "Email Automation",
      description:
        "Draft and send professional application emails with your resume directly through Gmail",
    },
    {
      icon: <FileText className="w-5 h-5" />,
      title: "Google Docs Integration",
      description:
        "Generate ATS-optimized resumes directly in your Google Drive with professional formatting",
    },
    {
      icon: <Zap className="w-5 h-5" />,
      title: "Real-Time AI Chat",
      description:
        "Chat with AI to refine your resume, get suggestions, and make improvements instantly",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Upload your resume to Google Drive and share the link with Resumify",
    },
    {
      step: "2",
      title: "AI Reads & Creates Profile",
      description:
        "Our AI agent analyzes your document and automatically creates a comprehensive profile",
    },
    {
      step: "3",
      title: "Paste Job Description",
      description:
        "Add any job posting you're interested in to tailor your resume specifically for that role",
    },
    {
      step: "4",
      title: "Get Optimized Resume",
      description:
        "Receive an ATS-optimized resume in Google Docs, perfectly matched to the job requirements",
    },
    {
      step: "5",
      title: "Draft & Send Emails",
      description:
        "Create professional application emails and send them directly through your Gmail",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-500/5 dark:bg-indigo-500/10 rounded-full blur-3xl animate-pulse"
      ...
      {/* Hero Section */}
      <section className="relative z-10 pt-12 pb-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-12 leading-relaxed max-w-3xl mx-auto">
              Connect your Google Doc, paste any job description, and get an
              ATS-optimized resume with automated email drafting—all powered by
              AI.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              From profile creation to email sending—automated, intelligent, and
              effortless
            </p>
          </div>
      ...
      <section
        id="how-it-works"
        className="relative z-10 py-24 px-4 sm:px-6 lg:px-8 bg-gray-50/50 dark:bg-gray-900/30"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {howItWorks.map((item, idx) => (
              <Card
                key={idx}
                className="bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 hover:shadow-xl transition-shadow relative overflow-hidden group"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-10">
                Built for modern job seekers who need speed, precision, and
                automation
              </p>
      ...
      <section className="relative z-10 py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            ...
            with AI-powered, job-tailored resumes
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-2 border-white text-blue-600  h-14 px-10 text-lg"
            >
